...
const HostelDashboard: React.FC<HostelDashboardProps> = ({
 ...
 return (
  <Card className="bg-[#202020] border-none text-white p-5 rounded-lg max-w-full">
   ...
   <CardContent className="flex flex-col md:flex-row justify-between items-start space-y-6 md:space-y-0 md:space-x-4">
    {/* Chart Section */}
    <div className="flex flex-col items-center md:w-1/4">
     <PieChart width={160} height={360}>
      <Pie
       data={chartData}
       dataKey="value"
       innerRadius={50}
    ...
    <div className="flex justify-center items-start md:w-1/4 mt-4 md:mt-0">
     <FurnitureList />
    </div>
   </CardContent>
  </Card>
